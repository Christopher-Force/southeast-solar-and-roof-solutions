...
import beforeAndAfter from "../../assets/img/RoofBeforeAfter.png"
        ...
        <section className="text-green-600 body-font mx-2">
            <div className=" pt-4 md:pt-8">
                <div className=""  id="topreveal">
                    <h2 className="text-primary-focus text-3xl title-font font-medium text-center mt-6">
                ...
                <div className="container lg:flex justify-center pb-12 mt-12 mx-auto">
                    <div className="basis-1/2 m-4 lg:mr-8">
                        <img src={beforeAndAfter} alt="before and after" />
                    </div>
                    <div className="basis-1/3 m-4">
                        <h2 className="text-xl title-font font-medium text-primary-focus">Contact Us For 15% Off Your Free Estimate!</h2>
                        <p className="text-green-200 text-lg pt-4 pb-4">We have great reasons to believe we're the best. A Roof Shampoo will provide with immediate results that you can see from the road. We're not kidding. While we're on the roof, more often than not the neighbors come out and watch the amazing process! 
                        <br />
                        <br />
                        For a limited time, we are offering a 15% discount for new customers who are looking to increase their home curb appeal. Click below for your free estimate!</p>
                        <span className="btn text-lg text-primary-focus">Get Free Quote</span>
                    </div>
                </div>
                {/* Confusion section */}
                        ...
                        <div className="flex flex-col items-center text-center justify-center" id="cleaningtitle">
                            <div className="flex flex-row justify-center lg:justify-start h-12">
                                ...
                                <span className="align-center">
                                    <h2 className="pl-2 text-orange-400 text-lg title-font font-medium mb-3 py-3">
                ...
                <div className="container px- pb-12 lg:mt-12 mx-auto">
                    {/* F&C title */}
                    <div className=""  id="topreveal">
                        <h2 className="text-primary-focus text-2xl title-font font-medium text-center mt-6 lg:-mt-6 ">
                            Why We're Different!
                        </h2>
                        <div className="flex flex-col items-center text-center justify-center">
                            <div className="w-52 h-1 bg-primary-focus rounded mt-2 mb-8 " />
                    ...
                    <div className="lg:flex ">
                        {/* features list */}
                        <div className="basis-1 lg:basis-1/2 mb-10 lg:items-start items-center rounded-md  border-gray-900 border-2 border-white mr-1 xl:mr-4">
                            {/* F&C TITLE */}
                            <div id="topreveal">
                                <h2 className="text-orange-400 text-lg title-font font-medium text-center mt-6">
                                    Your Benefits
                                </h2>
                                <div className="flex flex-col items-center text-center justify-center">
                            ...
                            <div className="grid justify-center lg:pt-6 lg:text-left text-center">
                                {/* eco-friendly */}
                                <div className="mb-2 m-1 lg:items-start items-center border-2 rounded-md p-2 shadow-2xl shadow-slate-500 px-4 lg:h-[19rem] xl:h-64" id='card1'>
                                ...
                                {/* stain free */}
                                <div className="mb-2 m-1 lg:items-start items-center border-2 rounded-md p-2 shadow-xl shadow-slate-500 px-4 lg:h-[17rem] xl:h-52" id='card2'>
                                    <div className="flex-grow">
                                ...
                                {/* non damaging */}
                                <div className="mb-2 m-1 lg:items-start items-center border-2 rounded-md p-2 shadow-2xl shadow-slate-500 px-4 lg:h-[19rem] xl:h-64" id="card3">
                                    <div className="flex-grow">
                                ...
                                {/* Gentle */}
                                <div className="mb-2 m-1 lg:items-start items-center border-2 rounded-md p-2 shadow-xl shadow-slate-500 px-4 lg:h-[17rem] xl:h-[14rem]" id='card4'>
                                    <div className="flex-grow">
                        ...
                        {/* competition list */}
                        <div className="basis-1 lg:basis-1/2 mb-10 lg:items-start items-center rounded-md  border-gray-900 border-2 border-white mr-1 xl:ml-4" >
                            ...
                            <div className="grid justify-center lg:pt-6 lg:text-left text-center">
                                ...
                                <div className="mb-2 m-1 lg:items-start items-center border-2 rounded-md p-2 px-4 lg:h-[19rem] xl:h-64 border-primary-focus shadow-primary-focus shadow-lg" id='card1'>
                                    <div className="flex-grow">
                                ...
                                <div className="mb-2 m-1 lg:items-start items-center border-2 rounded-md p-2 px-4 lg:h-[17rem] xl:h-52 border-red-600 shadow-red-600 shadow-md" id='card2'>
                                    <div className="flex-grow">
                            
                                        <div className="flex flex-row justify-center lg:justify-start h-12">
                                            <img src={stainBubble} alt="eco friendly" className="w-12 h-12" />
                                            <span className="align-center">
                                                <h2 className="pl-2 text-red-500 text-lg title-font font-medium mb-3 py-3">
                                                2) Bleach Roof Cleaning Method
                                                </h2>
                                            </span>
                                        </div>
                                        <div className="flex flex-col items-center text-center lg:items-start justify-center">
                                            <div className="w-48 h-1 bg-red-500 rounded mt-2 mb-4" />
                                        </div>
                                        <p className="leading-relaxed text-green-200">
                                ...
                                <div className="mb-2 m-1 lg:items-start items-center border-2 rounded-md p-2 px-4 lg:h-[19rem] xl:h-64 border-red-600 shadow-red-600 shadow-md" id="card3">
                                    <div className="flex-grow">
                                ...
                                <div className="mb-2 m-1 lg:items-start items-center border-2 rounded-md p-2 px-4 lg:h-[17rem] xl:h-[14rem] border-red-600 shadow-red-600 shadow-md" id='card4'>
                                    <div className="flex-grow">
