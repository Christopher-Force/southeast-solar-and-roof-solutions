...
export default function AnnualSolar () {
    return (
            ...
            <div class="container px-5 py-24 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div class="md:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <p class="leading-relaxed">Annual contracts are available for discounted solar panel cleaning! Our services are also offered at regular price for a job, but our clients love our professional work so much, they normally choose us for our yearly contracts. Contact us by telephone or email below for a detailed estimate!</p>
