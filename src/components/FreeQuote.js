        ...
        <div class="card lg:card-side border-2 w-full xl:w-full px-0.5 md:px-6 md:mx-6 lg:mx-0">
          <div class="card-body">
            ...
            <div className="grid lg:grid-cols-3">
              <p className="text-white lg:col-span-2 pr-8">We assess four elements that might influence the cost of your present solar maintenance requirements.<br className=""/><br />Click <span className="lg:hidden">below</span> to get your free estimate for your system!</p>
              <Link to="/estimate">
                <div className="grid">
