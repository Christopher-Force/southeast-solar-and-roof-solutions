...
export default function BannerLearn () {
    return(
        <div className="alert bg-gray-800 rounded-none shadow-lg drop-shadow-lg flex flex-col relative z-20 text-sm md:text-md">
                {/* Banner text */}
