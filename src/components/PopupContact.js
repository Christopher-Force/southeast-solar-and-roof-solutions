export default function PopupContact () {
    return (
      ...
      <div className="lg:pb-4 lg:pt-8 h-full">
        ...
        {/* second half */}
        <div className="flex flex-col lg:flex-row justify-center lg:pt-0">
            ...
            <div className="basis-1 lg:basis-2/3 flex flex-col relative justify-center md:ml-2 lg:justify-self-start pt-2">
