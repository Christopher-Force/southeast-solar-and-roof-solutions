...
export default function Footer() {
    return(
        <footer className="bg-gradient-to-r from-orange-900 to-orange-600 text-lime-400 body-font">
            <div className="container px-5 py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 m-auto text-center md:text-left">
                    <Link to="/">
                        <div className="flex title-font font-medium items-center md:justify-start justify-center text-white hover:motion-safe:animate-pulse">
            ...
            <div className="bg-black">
                ...
                <p className="text-lime-400 text-sm text-center sm:text-left">© 2022 Southeast Solar and Roof Solutions
                </p>
                {/* FAVICONS BELOW */}
                {/* <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                    ...
                    <div className="ml-3 text-lime-400">
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
