...
<section className="text-green-600 body-font mx-2">
  <div className="container px-5 py-12 mt-12 mx-auto flex flex-wrap border-2">
    <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
      <img alt="feature" className="object-cover object-center h-64 w-full" src={iSolar} />
    </div>
    <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
      <div className="flex flex-col mb-10 lg:items-start items-center">
        ...
        <div className="flex-grow">
          <h2 className="text-green-400 text-lg title-font font-medium mb-3">Shooting Stars</h2>
      ...
      <div className="flex flex-col mb-10 lg:items-start items-center">
        ...
        <div className="flex-grow">
          <h2 className="text-green-400 text-lg title-font font-medium mb-3">The Catalyzer</h2>
          <p className="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
        </div>
      </div>
      <div className="flex flex-col mb-10 lg:items-start items-center">
        ...
        <div className="flex-grow">
          <h2 className="text-green-400 text-lg title-font font-medium mb-3">Neptune</h2>
          <p className="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
