    ...
    return (
        <section className="text-white body-font bg-black">
            <div className="container px-5 py-12 mx-auto flex flex-wrap items-center">
                ...
                <h1 className="title-font font-medium text-3xl text-white">Sign up to stay updated.</h1>
                <p className="leading-relaxed mt-4">Stop throwing your hard earned money away and stay informed of the latest deals and technology.</p>
                </div>
                ...
                <button className="text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg mt-4">Button</button>
                <p className="text-xs text-gray-500 mt-3">Stay updated with the latest technology.</p>
                </div>
            </div>
        </section>
    )
