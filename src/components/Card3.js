...
export default function Card3 () {
    return(
        <div className="flex relative sm:p-1 w-full grid justify-items-center pl-1 mt-4" id="card3">
            <div className="border-2 rounded-lg border-gray-200 border-opacity-50 p-2 bg-black h-full grid justify-items-center mr-1 w-full">
                {/* IMAGE 2 */}
                <div className="grid justify-items-center -mb-2 md:mb-0">
                    <Link to="/statewide">
                        <div className="w-32 md:w-64 md:h-64 sm:mb-0 mb-2 md:mb-6 bg-black flex-shrink-0 justify-items-center grid mt-4">
